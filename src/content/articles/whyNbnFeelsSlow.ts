export const whyNbnFeelsSlowContent = {
  ...
  article: {
    title: "Why Fast NBN (or Starlink) Still Feels Slow (And How To Fix It)",
    body: `Speed tests might show fast NBN speeds like 100 Mbps or even 250 Mbps. But Netflix still buffers, Zoom calls drop, and the kids complain about lag. In the back bedroom, the Wi-Fi just doesn't work.
...
export const whyNbnFeelsSlowImages = [
  {
    src: "/images/work_gallery/wifi_survey.jpeg",
    alt: "Wi-Fi survey equipment used for home network testing in Perth",
  },
  {
    src: "/images/router-bad-location.jpeg",
    alt: "Perth home technology installation by Blake Smart Solutions",
  },
  {
    src: "/images/mesh.jpg",
    alt: "Network and communications installation work in a Perth home",
  },
];
