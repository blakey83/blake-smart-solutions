export const wifiProblemsPerthPageContent = {
  ...
  whySection: {
    ...
    paragraph:
      "WiFi troubleshooting from someone who understands homes, signal issues and communications systems.",
    bullets: [
      "Perth-based",
      "Fully insured",
...
export const whyChooseUsWifiProblems = {
  whySection: wifiProblemsPerthPageContent.whySection,
};
