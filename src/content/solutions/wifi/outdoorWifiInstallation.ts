...
export const outdoorWifiInstallation: SolutionDetailPage = {
    ...
    heroImage: "/images/solutions/wifi/darlington/bushland-property.webp",
    heroImageAlt:
      "Roofline and surrounding trees at a Darlington property in the Perth Hills",
    review: sharedReview,
    problem: {
    ...
    proof: {
      image: "/images/solutions/wifi/darlington/roof-mounted-link.webp",
      imageAlt:
        "Outdoor wireless bridge on a roof mount overlooking a leafy Darlington garden",
      title: "A network planned around the property",
      intro:
        "Our Darlington job shows why outdoor networking starts with the site: trees, rooflines and separate buildings all influence equipment placement. The unit pictured is a building-to-building bridge; an outdoor access point serves phones and other Wi-Fi devices around the yard.",
      problem:
        "Gardens and detached buildings need different kinds of connectivity, and foliage can affect the wireless path.",
      solution:
        "Choose access points for outdoor coverage and dedicated links for separate buildings, with mounting positions assessed for each location.",
      result:
        "A network design matched to the places you need connected, with coverage and link performance checked on site.",
    },
    faqs: [
      {
