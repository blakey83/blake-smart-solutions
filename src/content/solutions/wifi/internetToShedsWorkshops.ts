...
bullets: [
  "Get reliable Wi-Fi inside the shed or workshop where you actually need it",
  "Connect workstations, cameras, TVs, phones and smart equipment without relying on weak house Wi-Fi",
  "Carry the network reliably across the yard or between detached buildings",
  "Use a dedicated wireless link or cabling, depending on what suits the property",
  "Avoid boosters and mesh systems that struggle across distance, walls and metal buildings",
  "Installed, aligned, configured and tested from the main building right through to the Wi-Fi inside",
],

heroCtaLines: [
  "Tell us roughly how far the building is from the house and what you need connected.",
  "We’ll come back with a clear quote for the right way to get reliable internet inside.",
],
...
heroImageAlt:
  "Detached sheds and workshops across a large property",
