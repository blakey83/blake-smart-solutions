  ...
  completedJobs: [
    {
      ...
      description:
        "The owner had built a shed for his toys, TV and music system, but the house network didn’t reach and mobile coverage was patchy. A dedicated wireless bridge brought the home network across to the shed, giving him reliable connectivity for streaming and connected devices.",
      outcome:
    ...
    },
    {
      ...
      location: "Hocking, WA",
      description:
        "A husband and wife running their plumbing business from home both needed reliable internet in different parts of a large family house. The Telstra router provided a fast connection, but its Wi-Fi couldn’t cover the whole building. Two hardwired ceiling access points extended that connection throughout the home, giving the family strong coverage and speeds of up to 500 Mbps where they actually work and use the network.",
      outcome:
    ...
    },
    {
      ...
      description:
        "With a newly built home, the owner wanted reliable connectivity built around how the property would actually be used rather than depending on one router after moving in. The finished network provides consistent Wi-Fi throughout the home, wired connections for equipment that benefits from a permanent link, and a separate network connection in the office for sensitive work requirements.",
      outcome:
    ...
    },
    {
      ...
      description:
        "The customer wanted stronger Wi-Fi coverage but didn’t want access points visible on the ceilings of her home. Wall-mounted units provided a more discreet installation while still delivering the coverage and performance she needed.",
      outcome:
