...
import { darlingtonWholePropertyNetworkCaseStudy } from "@/content/case-studies/starlinkCityBeach";
import {
  absoluteUrl,
  buildArticleNode,
  buildSchemaGraph,
...
const content = darlingtonWholePropertyNetworkCaseStudy;
...
export default function DarlingtonWholePropertyNetworkCaseStudyPage() {
  return (
    <>
      <script
